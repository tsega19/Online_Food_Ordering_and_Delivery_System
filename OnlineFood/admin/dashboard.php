                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       ...
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
                         ...
                         <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">delivery person</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="all_restaurant.php">All Delivery person</a></li>
                                <li><a href="add_delivery.php">Add delivery peron</a></li>
                                <!-- <li><a href="add_restaurant.php">Add Restaurant</a></li> -->
